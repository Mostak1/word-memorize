import{r as i,b as x,j as e,H as N,L as v}from"./app-BOWqY3x_.js";import"./app-DnUa_b9w.js";function k({categories:t=[],freeWordsCount:p=0}){const[l,h]=i.useState("en"),g=s=>{if(!s)return"img/landing/personal_word.webp";const n=s.toLowerCase();return n.includes("academic")||n.includes("ielts")?"img/landing/academic.webp":n.includes("basic")?"img/landing/basic.webp":n.includes("advanced")?"img/landing/advanced_essantial_words.webp":n.includes("master")||n.includes("iba")||n.includes("gre")||n.includes("sat")?"img/landing/master_vocab.webp":"img/landing/personal_word.webp"},f=["Bagerhat","Bandarban","Barguna","Barisal","Bhola","Bogura","Brahmanbaria","Chandpur","Chapai Nawabganj","Chattogram","Chuadanga","Cumilla","Cox's Bazar","Dhaka","Dinajpur","Faridpur","Feni","Gaibandha","Gazipur","Gopalganj","Habiganj","Jamalpur","Jashore","Jhalokathi","Jhenaidah","Joypurhat","Khagrachari","Khulna","Kishoreganj","Kurigram","Kushtia","Lakshmipur","Lalmonirhat","Madaripur","Magura","Manikganj","Meherpur","Moulvibazar","Munshiganj","Mymensingh","Naogaon","Narail","Narayanganj","Narsingdi","Natore","Netrokona","Nilphamari","Noakhali","Pabna","Panchagarh","Patuakhali","Pirojpur","Rajbari","Rajshahi","Rangamati","Rangpur","Satkhira","Shariatpur","Sherpur","Sirajganj","Sunamganj","Sylhet","Tangail","Thakurgaon","Expat"],[o,c]=i.useState("register"),[d,b]=i.useState(!1),a=x({name:"",email:"",password:"",phone_number:"",learning_goal:"",location:""}),r=x({email:"",password:"",remember:!1}),j=s=>{s.preventDefault(),a.post(route("register"),{onSuccess:()=>a.reset("password")})},u=s=>{s.preventDefault(),r.post(route("login"),{onSuccess:()=>r.reset("password")})};return i.useEffect(()=>{l==="bn"?(document.body.classList.remove("lang-en"),document.body.classList.add("lang-bn")):(document.body.classList.remove("lang-bn"),document.body.classList.add("lang-en"))},[l]),i.useEffect(()=>{const s=new IntersectionObserver(n=>{n.forEach(m=>{m.isIntersecting&&m.target.classList.add("vis")})},{threshold:.1});return document.querySelectorAll(".sr").forEach(n=>s.observe(n)),()=>s.disconnect()},[]),e.jsxs("div",{className:l==="bn"?"lang-bn":"lang-en",children:[e.jsx(N,{children:e.jsx("title",{children:"VocabPix — Learn Vocabulary Scientifically"})}),e.jsx("style",{children:`
