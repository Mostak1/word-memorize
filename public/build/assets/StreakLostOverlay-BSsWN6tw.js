import{r as n,u as m,j as e}from"./app-BVsLoiLB.js";function v({isOpen:o,onClose:d,prevStreak:r,xpBalance:f=0,onRepair:p}){const s=f>=5e3,[i,b]=n.useState(!1),{t:a}=m(),[u,c]=n.useState(o),[x,g]=n.useState(!1);return n.useEffect(()=>{if(o){c(!0);const t=setTimeout(()=>g(!0),50);return()=>clearTimeout(t)}else{g(!1);const t=setTimeout(()=>c(!1),600);return()=>clearTimeout(t)}},[o]),u?e.jsxs(e.Fragment,{children:[e.jsx("style",{children:`
                /* ── Keyframes ─────────────────────────────────────────────── */
                @keyframes sl-fadeIn {
