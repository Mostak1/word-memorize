...
import { X, Share2, Facebook, MessageCircle, Send, Instagram, ArrowRight, CheckCircle2, Trophy } from "lucide-react";
...
export default function ListCompletedOverlay({ listName, onDismiss }) {
    ...
    const shareText = `I just mastered the entire "${listName}" word list on VocabPix! 🏆 My vocabulary is growing stronger!`;
        ...
        <div className={`fixed inset-0 z-[200] flex items-center justify-center p-4 bg-slate-900/40 backdrop-blur-md transition-opacity duration-300 ${isClosing ? "opacity-0" : "opacity-100"} animate-in fade-in`}>
            ...
            >
                ...
                <div className="pt-12 pb-6 px-8 text-center">
                    <span className="text-[10px] font-extrabold uppercase tracking-[0.2em] text-green-600 dark:text-green-400 mb-2 block">
                        Milestone Reached
                    </span>
                ...
                <div className="relative flex justify-center items-center py-4">
                    ...
                    <div className="absolute inset-0 flex justify-center items-center pointer-events-none">
                        <div className="w-56 h-56 bg-green-500/10 rounded-full blur-3xl animate-pulse" />
                        <svg viewBox="0 0 200 200" className="w-64 h-64 text-green-600/10 dark:text-green-500/10 fill-current overflow-visible">
                    ...
                    <div className="relative z-10 transition-transform duration-700 hover:scale-110 cursor-default drop-shadow-xl flex flex-col items-center">
                        <div className="w-32 h-32 bg-green-500 rounded-full flex items-center justify-center shadow-lg shadow-green-200 dark:shadow-none">
                            <Trophy className="w-16 h-16 text-white" strokeWidth={2.5} />
                        </div>
                        <div className="absolute -bottom-2 bg-white dark:bg-slate-800 px-4 py-1 rounded-full shadow-md border border-green-100 dark:border-green-900">
                            <span className="text-xs font-black text-green-600 dark:text-green-400">MASTERED</span>
                        </div>
                    </div>
                </div>
                ...
                <div className="px-10 pb-6 text-center">
                    <p className="text-slate-900 dark:text-white text-lg font-bold mb-1">
                        {listName}
                    </p>
                    <p className="text-slate-500 dark:text-slate-400 text-sm leading-relaxed font-medium">
                        Fantastic job! You've successfully mastered every single word in this list. Your dedication is paying off!
                    </p>
                </div>
