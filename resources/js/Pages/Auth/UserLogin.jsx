            ...
            <div className="w-full">
                ...
                <form onSubmit={submit} className="space-y-4">
                    ...
                    <Button
                        ...
                        variant="outline"
                        className="w-full h-12 border-2 border-gray-300 dark:border-zinc-700 hover:border-gray-400 font-semibold rounded-full transition-all flex items-center justify-center gap-3 mt-2"
                    >
                        {/* Google SVG */}
                        <svg
