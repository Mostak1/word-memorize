                                    ...
                                    <div className="pt-3 sm:pt-5">
                                        ...
                                        <p className="mt-4 text-sm/relaxed">
                                            ...
                                            export default function Welcome({ auth, laravelVersion, phpVersion }) {
                                                return (
                                                    <>
                                                        <Head title="Memorize Words" />

                                                        <div className="min-h-screen bg-gray-50 dark:bg-zinc-900 text-black">
                                                                ...
                                                                <div className="pt-6 px-4">
                                                                    ...
                                                                    <div className="bg-white dark:bg-zinc-900 p-4 shadow-sm">
                                                                        <div className="grid grid-cols-2 gap-4">
                                                                            <Link href={route('words.create')} className="flex flex-col items-center justify-center p-4 bg-white rounded-md shadow-md h-36">
                                                                            ...
                                                                            <Link href={route('exercise')} className="flex flex-col items-center justify-center p-4 bg-white rounded-md shadow-md h-36">
                                                                                <div className="mb-2 flex h-14 w-14 items-center justify-center rounded-full bg-[#E5201C]/10">
                                                                                    <svg xmlns="http://www.w3.org/2000/svg" className="h-7 w-7 text-[#E5201C]" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                                                            ...
                                                                            <Link href={route('statistics')} className="flex flex-col items-center justify-center p-4 bg-white rounded-md shadow-md h-36">
                                                                                <div className="mb-2 flex h-14 w-14 items-center justify-center rounded-full bg-[#E5201C]/10">
                                                                            ...
                                                                            <Link href={route('words.index')} className="flex flex-col items-center justify-center p-4 bg-white rounded-md shadow-md h-36">
                                                                                <div className="mb-2 flex h-14 w-14 items-center justify-center rounded-full bg-[#E5201C]/10">
                                                                                    <svg xmlns="http://www.w3.org/2000/svg" className="h-7 w-7 text-[#E5201C]" viewBox="0 0 24 24" fill="currentColor">
                                                                        ...
                                                                        <div className="grid grid-cols-3 gap-4 mt-4">
                                                                            ...
                                                                            <Link href={route('settings')} className="flex flex-col items-center justify-center p-3 bg-white rounded-md shadow-md h-28">
                                                                                <div className="mb-2 flex h-10 w-10 items-center justify-center rounded-full bg-[#E5201C]/10">
                                                                                    <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 text-[#E5201C]" viewBox="0 0 24 24" fill="currentColor">
                                                                    ...
                                                                    <footer className="py-6 text-center text-sm text-black/60 dark:text-white/60">
