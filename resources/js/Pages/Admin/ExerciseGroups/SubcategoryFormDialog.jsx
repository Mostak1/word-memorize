...
export default function SubcategoryFormDialog({
    ...
    const submit = (e) => {
        ...
        const url = isEditing
            ? route("admin.exercise-groups.subcategories.update", [
                  exerciseGroup.id,
                  subcategory.id,
              ])
            : route("admin.exercise-groups.subcategories.store", exerciseGroup.id);
        ...
        router[method](
            ...
            { name: name.trim() },
            {
                ...
                onSuccess: () => {
                    toast.success(
                        isEditing ? "Subcategory updated!" : "Subcategory created!",
                    );
                    onOpenChange(false);
                },
                onError: (errs) => {
